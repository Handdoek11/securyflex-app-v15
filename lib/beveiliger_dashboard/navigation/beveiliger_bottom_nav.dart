...
import 'package:securyflex_app/beveiliger_dashboard/models/beveiliger_tab_data.dart';
import 'package:flutter/material.dart';

class BeveiligerBottomNav extends StatefulWidget {
  const BeveiligerBottomNav({
    super.key,
    this.tabIconsList,
    this.changeIndex,
    this.addClick,
  ...
  final List<BeveiligerTabData>? tabIconsList;
  @override
  State<BeveiligerBottomNav> createState() => _BeveiligerBottomNavState();
}

class _BeveiligerBottomNavState extends State<BeveiligerBottomNav>
                  ...
                  child: ScaleTransition(
                    ...
                    child: DecoratedBox(
                      ...
                      child: Material(
                        color: Colors.transparent,
                        child: InkWell(
                          splashColor: DesignTokens.colorWhite.withValues(alpha: 0.1),
  ...
  void setRemoveAllSelection(BeveiligerTabData? tabIconData) {
    if (!mounted) return;
    setState(() {
      widget.tabIconsList?.forEach((BeveiligerTabData tab) {
...
class TabIcons extends StatefulWidget {
  ...
  final BeveiligerTabData? tabIconData;
