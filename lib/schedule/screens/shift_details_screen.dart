...
/// ShiftDetailsScreen - Detailed view of a single shift
/// 
/// Shows comprehensive shift information including requirements,
/// applications, and management actions.
class ShiftDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Dienst Details'),
